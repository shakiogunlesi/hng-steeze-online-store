    ...
    return (
        <div className="flex flex-col mx-auto justify-start items-start my-20 overflow-hidden">
            ...
            <div className="w-full flex flex-col justify-start items-start mt-6">
                ...
                <div className="container mmx-auto mt-5 md:p-5 rounded-lg">
                    {cartItems.length === 0 ? (
                        ...
                        <div className="cart-items">
                            {cartItems.map((item) => (
                                <div key={item.id} className="cart-item flex justify-between items-center mb-3 border-b">
                                    <div className="cart-item-info 
                                        ...
                                        <div className="md:ml-12 md:mr-12 ml-2 mr-2 text-left">
                            ...
                            <div className="cart-item-info w-[100%] md:flex-row xl:justify xl:items-end md:items-end sm:items-start xl:gap-6 border border-gray-300 shadow-md rounded-xl px-12 py-5 mt-4">
                                <p className="flex md:text-5xl text-3xl font-[600]">Price Details</p>
                                <div className='text-left md:pl-20 mt-16'>
                                    <div className="cart-total mt-5 mb-4 flex flex-column flex-row md:w-[362px] gap-[200px]">
                                        <div>
                                        ...
                                        <h2 className="text-[28px] font-[600] mb-2 leading-[33.6px]">$0:00</h2>
                                        </div>
                                    </div>
                                    <div className="border-t-2 border-black md:w-[43%]"></div>
                                    <div className="cart-actions mt-5">
                                        <div className="cart-total mt-5 mb-4 flex flex-column flex-row md:w-[362px] gap-[240px]">
                                            <div>
